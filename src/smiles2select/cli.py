...
def _build_config(args: argparse.Namespace) -> RunConfig:
    ...
    return RunConfig(
        ...
        compute_preparability=args.docking_readiness or args.tautomers,
        compute_tautomers=args.tautomers,
        docking_engine=args.docking_engine if (args.docking_readiness or args.tautomers) else None,
